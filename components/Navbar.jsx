...
const Navbar = () => {
  ...
  return (
    <div className="relative  w-full z-20" style={{ padding: "0.8rem 1.5rem" }}>
      <nav className="flex justify-between items-center">
        <p className="font-editorial-regular text-[1.2rem] text-light-300">
          true.kind.
        </p>
        <ul className="flex text-light-300 justify-center gap-10 items-center uppercase text-[0.6rem]">
